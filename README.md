...
* The second model was trained using data scraped from Metacritic using 22 games (See: MetacriticModel.ipynb).
* The model trained on Amazon data led to a higher degree of accuracy than the Metacritic model.
